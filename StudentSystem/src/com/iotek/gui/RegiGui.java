...
public class RegiGui extends GuiView{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == okButton) {
			...
			boo = new PanDuan().TwoPass(new String(passText.getPassword()), new String(passAginText.getPassword()));
			if (boo){
				Temp tp = new Temp();
